...
class CanalTestCase(TestCase):
    def setUp(self):
        self.usuario_a = User.objects.create(username='Santi', password='1234567')
        self.usuario_b = User.objects.create(username='Shaiel', password='1234567')
        self.usuario_c = User.objects.create(username='Nona', password='1234567')
